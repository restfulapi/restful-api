    ...
    resource 'things' config {
        ...
        representation {
            ...
            marshallers {
                ...
                marshaller {
                    instance = new net.hedtech.restfulapp.marshallers.json.ThingClassMarshaller(grailsApplication)
                    priority = 101
                }
            }
            jsonExtractor {}
        ...
        representation {
            ...
            marshallers {
                ...
                marshaller {
                    instance = new net.hedtech.restfulapp.marshallers.xml.ThingClassMarshaller(grailsApplication)
                    priority = 101
                }
            }
            extractor = new net.hedtech.restfulapi.extractors.xml.MapExtractor()
        ...
        representation {
            ...
            marshallers {
                marshaller {
                    instance = new net.hedtech.restfulapp.marshallers.xml.v0.ThingClassMarshaller()
                    priority = 101
                }
            }
            extractor = new net.hedtech.restfulapp.extractors.xml.v0.ThingExtractor()
        }
        representation {
            mediaTypes = ['application/vnd.hedtech.thing.v1+xml']
            marshallers {
                marshaller {
                    instance = new net.hedtech.restfulapp.marshallers.xml.v1.ThingClassMarshaller()
                    priority = 101
                }
            }
            extractor = new net.hedtech.restfulapp.extractors.xml.v1.ThingExtractor()
        }
        representation {
            ...
            extractor = new net.hedtech.restfulapp.extractors.json.ThingDefaultDescriptionExtractor()
        }
        ...
        representation {
            ...
            marshallers {
                ...
                jsonDomainMarshaller {
                    supports net.hedtech.restfulapp.Thing
                    priority = 101
                    additionalFields { map ->
                        def json = map['json']
    ...
    resource 'groovy-thing-wrappers' config {
        representation {
            ...
            marshallers {
                ...
                jsonBeanMarshaller {
                    supports net.hedtech.restfulapp.ThingWrapper
                    includesFields {
                        field 'things'
                        field 'complexCode'
                        field 'xlarge'
